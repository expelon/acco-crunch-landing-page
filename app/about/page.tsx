    ...
    <div className="min-h-screen bg-[#f8f4e5]">
      ...
      <section className="py-16 bg-[#1d1d1d]">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h3 className="text-2xl sm:text-3xl font-semibold text-white">Vision & Mission</h3>
          ...
          >
            {/* Mission Card */}
            <motion.div variants={fadeUp} className="group rounded-2xl bg-[#2a2a2a] p-8 shadow-md border border-white/10 text-white">
