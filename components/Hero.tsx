        ...
        <div className="grid md:grid-cols-2 gap-2 md:gap-3 items-center">
          ...
          >
            <div className="md:bg-transparent md:shadow-none md:rounded-none bg-[#fdfcf5] rounded-2xl shadow-md px-5 sm:px-6 lg:px-8 pt-6 sm:pt-8 lg:pt-10 pb-6 sm:pb-8 mb-0">
              <h1 className="text-[clamp(1.95rem,7vw,2.6rem)] sm:text-4xl md:text-4xl lg:text-[44px] font-medium text-[#1B263B] leading-tight tracking-wide mb-4 text-balance">
                <span className="block lg:hidden">Making every business move a confident one</span>
